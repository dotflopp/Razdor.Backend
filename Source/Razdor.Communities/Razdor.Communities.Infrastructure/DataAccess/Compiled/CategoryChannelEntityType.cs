...
namespace Razdor.Communities.Infrastructure.DataAccess
{
    ...
    public partial class CategoryChannelEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "Razdor.Communities.Domain.Channels.CategoryChannel",
                typeof(CategoryChannel),
                baseEntityType,
                discriminatorProperty: "Type",
                discriminatorValue: ChannelType.CategoryChannel,
                propertyCount: 0);
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.SetOriginalValuesFactory(
                ...
                {
                    var entity = ((CategoryChannel)(source.Entity));
            ...
            runtimeEntityType.AddAnnotation("Mongo:CollectionName", "Categories");
