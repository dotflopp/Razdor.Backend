...
{
    public partial class CommunityMongoDataContextModel
    {
        private CommunityMongoDataContextModel()
            : base(skipDetectChanges: false, modelId: new Guid("359cb592-397e-41a9-aa2e-ea85914b37af"), entityTypeCount: 14)
        {
        }
