...
{
    public partial class IdentityPostgreSqlContextModel
    {
        private IdentityPostgreSqlContextModel()
            : base(skipDetectChanges: false, modelId: new Guid("ec606b76-239a-4f2f-a807-3488a1b28968"), entityTypeCount: 1)
        {
        }
