...
namespace Razdor.Signaling.Routing.Signaling;

public class SignalingHub : Hub
{
    private readonly ILogger<SignalingHub> _logger;
    private readonly IDictionary<string, string> _sessionConnections;

    private readonly ISignalingInternalService _signalingService;
